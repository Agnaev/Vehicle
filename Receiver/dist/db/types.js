...
exports.Delete = exports.Update = exports.Create = exports.GetSensors = void 0;
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, db_connection_1.makeRequest("SELECT * FROM SensorsTypes")];
                case 1:
...
function Create(item) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var requestResult, count, sensorId, result, exc_2;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                ...
                case 4:
                    sensorId = (_a.sent()).recordsets[0][0];
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            db_connection_1.makeRequest("\n            UPDATE SensorsTypes\n            SET Name = '" + item.Name + "',\n            Description = '" + item.Description + "',\n            MaxValue = '" + item.MaxValue + "',\n            MinValue = '" + item.MinValue + "'\n            WHERE id = '" + item.Id + "'")
                .then(function () { return db_connection_1.makeRequest("SELECT * FROM SensorsTypes WHERE Id=" + item.Id); })
...
function Delete(item) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            db_connection_1.makeRequest("DELETE FROM SensorsTypes WHERE Id = " + item.Id)
                .catch(function (exc) {
